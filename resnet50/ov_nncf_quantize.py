...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type=str, default='./models/resnet50-v1-12.xml')
    parser.add_argument('--output_path', type=str, default='./models/resnet50-v1-12_int8.xml')
    ...
    dataset = ResNet50DataReader(dataset_path, input_shape, model.inputs[0].get_any_name())
